...
public class Television extends DispositivoEstacionario {
    ...
    public Television(int precio, int pantalla, int ram, int almacenamiento, String nombre, String marca, String procesador, String gama, String sistemaOperativo, String instalacion) {
